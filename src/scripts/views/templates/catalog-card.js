...
const catalogCard = (restaurant) => `
    <article class="catalog__card" tabindex="0">
        ...
        <img class="catalog__img lazyload" data-src="${CONFIG.IMAGE_SMALL + restaurant.pictureId}" alt="${restaurant.name}" loading="lazy" width="300" height="150">
